 ...
 */
class BookmarksHelper extends Helper{
	 ...
	 */
	var $defaults = array('google','facebook','yahoo','digg','delicious');
	 ...
	 */
	function getBookmarks($pagetitle, $url = null, $sites = array(), $prefix = ''){
		if(empty($url)){
		...
		return '<div id="bookmarklets">' . $prefix . $output . '</div>';
	}
